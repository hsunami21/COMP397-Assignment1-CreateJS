...
\n\n\n\n\nWhich portal do you go through?", "18px Consolas", "#000000", 320, 190);
        ...
        // PRIVATE METHODS
        // EVENT HANDLERS
        R.prototype._clickRedButton = function (event) {
            changeState(config.DEATH1_STATE);
        };
        R.prototype._clickGreenButton = function (event) {
            changeState(config.DEATH2_STATE);
        };
        R.prototype._clickBlueButton = function (event) {
            changeState(config.RB_STATE);
        };
        return R;
    })(objects.Scene);
    states.R = R;
