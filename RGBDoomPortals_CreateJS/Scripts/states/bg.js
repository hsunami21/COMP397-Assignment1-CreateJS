...
\n\n\n\n\nWhich portal do you go through?", "18px Consolas", "#000000", 320, 190);
        ...
        // PRIVATE METHODS
        // EVENT HANDLERS
        BG.prototype._clickRedButton = function (event) {
            changeState(config.BGR_STATE);
        };
        BG.prototype._clickGreenButton = function (event) {
            changeState(config.DEATH3_STATE);
        };
        BG.prototype._clickBlueButton = function (event) {
